...
static char * stringConcaten(char * destination, const char * const source, const char delimiter)
{
    if(source == NULL)
    {
        return destination;
...
static bool compareIndividualsBool(const void* first,const void* second){
    ...
    char * firstName = stringConcaten(NULL, ((Individual *) first)->givenName, '\0');
    firstName = stringConcaten(firstName, ",", '\0');
    firstName = stringConcaten(firstName, ((Individual *) first)->surname, '\0');

    char * secondName = stringConcaten(NULL, ((Individual *) second)->givenName, '\0');
    secondName = stringConcaten(secondName, ",", '\0');
    secondName = stringConcaten(secondName, ((Individual *) second)->surname, '\0');
