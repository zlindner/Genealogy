...
GEDCOMobject* oneIndivNoFam(void){
    //Initilize reference object
    GEDCOMobject* refObj = malloc(sizeof (GEDCOMobject));
...
GEDCOMobject* individualsNoFam(void){
    //Initilize reference object
    GEDCOMobject* refObj = malloc(sizeof (GEDCOMobject));
...
GEDCOMobject* oneFamNoIndiv(void){
    //Initilize reference object
    GEDCOMobject* refObj = malloc(sizeof (GEDCOMobject));
...
GEDCOMobject* nuclearFamily(void){
    //Initilize reference object
    GEDCOMobject* refObj = malloc(sizeof (GEDCOMobject));
...
GEDCOMobject* simpleValid2Gen(void){
    //Initilize reference object
    GEDCOMobject* refObj = malloc(sizeof (GEDCOMobject));
...
GEDCOMobject* simpleValid2GenE1(void){
    //Initilize reference object
    GEDCOMobject* refObj = malloc(sizeof (GEDCOMobject));
...
GEDCOMobject* simpleValid2GenE2(void){
    //Initilize reference object
    GEDCOMobject* refObj = malloc(sizeof (GEDCOMobject));
...
bool _tBardObjectValid(GEDCOMobject* obj){
    //11 families
    //31 individuals
